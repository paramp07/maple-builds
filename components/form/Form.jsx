...
console.log(BackgroundSidebar.src)
...
const Form = () => {
  ...
  const [steps, setSteps] = useState([
    { id: 1, title: "Personal Info", active: true },
    ...
    <div className="container mx-0">
      <div className="bg-[#d6d9e6] md:bg-white rounded-xl md:p-3 md:flex justify-center">
        <div className="relative">
          <img
            className="hidden object-cover h-[760px] rounded-xl saturate-0 contrast-200 md:block"
            src={BackgroundSidebar.src}
            alt="sidebar"
          />
          <img
          ...
          <div className="absolute inset-0 flex justify-center mt-8 space-x-10 md:space-x-0 md:block md:mt-0 md:pl-6 md:pt-8 md:space-y-12">
            {steps.map((step) => (
              <Step
                key={step.id}
                number={step.id}
              ...
              >
                ...
                {stepNumber === 4 ? (
                  <div
                    ...
                    className="px-5 py-3 font-medium text-white transition duration-100 rounded-lg cursor-pointer select-none bg-gray-950 hover:opacity-90"
                  >
                    Confirm
                  </div>
                ) : (
                  <div
                    onClick={nextStep}
                    className="px-5 py-3 mt-4 font-medium text-white transition duration-100 rounded-lg cursor-pointer select-none bg-gray-950 hover:opacity-90"
                  >
                    Next Step
                  </div>
                )}
